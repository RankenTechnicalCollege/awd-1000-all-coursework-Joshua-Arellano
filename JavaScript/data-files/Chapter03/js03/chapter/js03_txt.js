...
function showGames(){
    for (let i = 0; i < gameDates.length; i++){
        ...
        //Inclulde the result and score
        gameInfo += gameResults[i] + ": (" + runsScored[i] + " - " + runsAllowed[i] + ")";

        //Display innings played for suspended, shortened, or extra-inning
        if (gameInnings[i] < 5){
        ...
        //Close theh paragraph
        gameInfo += "</p>";

        //Write the ifnormation into a table cell
